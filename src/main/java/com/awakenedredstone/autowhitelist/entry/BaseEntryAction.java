...
public abstract class BaseEntryAction {
     ...
     */
    public abstract void registerUser(LinkedPlayerProfile profile);
     ...
     */
    public abstract void removeUser(LinkedPlayerProfile profile);
     ...
     */
    public void updateUser(LinkedPlayerProfile profile, @Nullable BaseEntryAction oldEntry) {
        if (oldEntry != null) {
