...
/**
 * The registration of the messages for the register command
 *
...
public class RegisterCommandMessages {
    ...
    public static final Identifier UNQUALIFIED = ResponseMessage.<RegisterEmpty>register(RegisterMessages.UNQUALIFIED, (input, geyser) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.unqualified.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.unqualified.description")
    ));
    ...
    public static final Identifier NOT_FOUND = ResponseMessage.<RegisterEmpty>register(RegisterMessages.NOT_FOUND, (input, geyser) -> {
        boolean isUuid = UUIDUtil.isValidUuid(input);
        var type = isUuid ? "UUID" : "username";
        var edition = geyser ? "Bedrock" : "Java";

        List<TopLevelMessageComponent> components = new ArrayList<>();
        components.add(MessageBuilder.translated("discord.autowhitelist.response.register.fail.not_found.title"));
        components.add(MessageBuilder.translated("discord.autowhitelist.response.register.fail.not_found.description", edition, type, input));

        if (geyser && !isUuid) {
            components.add(MessageBuilder.translated("discord.autowhitelist.response.register.fail.not_found.geyser_tip"));
        }
    ...
    public static final Identifier NOTHING_CHANGED = ResponseMessage.<RegisterEmpty>register(RegisterMessages.NOTHING_CHANGED, (input, geyser) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.nothing_changed.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.nothing_changed.description")
    ));
    ...
    public static final Identifier BANNED = ResponseMessage.<RegisterBanEntry>register(RegisterMessages.BANNED, (input, geyser, entry) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.banned.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.banned.description")
    ));
    ...
    public static final Identifier ALREADY_LINKED = ResponseMessage.<RegisterEmpty>register(RegisterMessages.ALREADY_LINKED, (input, geyser) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.linked.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.linked.description")
    ));
    ...
    public static final Identifier ALREADY_WHITELISTED = ResponseMessage.<RegisterEmpty>register(RegisterMessages.ALREADY_WHITELISTED, (input, geyser) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.whitelisted.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.whitelisted.description")
    ));
    ...
    public static final Identifier BROKEN_ACTION = ResponseMessage.<RegisterRoleAction>register(RegisterMessages.BROKEN_ACTION, (input, geyser, role, action) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.broken_action.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.broken_action.description", role.getId().asLong(), action.getType().id(), action.toString())
    ));
    ...
    public static final Identifier ERROR_WHILE_ADDING = ResponseMessage.<RegisterPlayerProfile>register(RegisterMessages.ERROR_WHILE_ADDING, (input, geyser, profile) -> List.of(
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.error_while_adding.title"),
      MessageBuilder.translated("discord.autowhitelist.response.register.fail.error_while_adding.description")
    ));
    ...
    public static final Identifier REGISTERED = ResponseMessage.<RegisterPlayerProfile>register(RegisterMessages.REGISTERED, (input, geyser, profile) -> Collections.singletonList(
      Section.of(
        ...
        MessageBuilder.translated("discord.autowhitelist.response.register.success.registered.title"),
        MessageBuilder.translated("discord.autowhitelist.response.register.success.registered.description")
      )
    ));
}
