...
public abstract class AbstractSlashCommand<T extends ApplicationCommandInteractionEvent> {
    ...
    protected ApplicationCommand.Type commandType = ApplicationCommand.Type.CHAT_INPUT;

    protected final @Nullable String prefix;

    public AbstractSlashCommand(String command) {
        this(command, null);
    }

    public AbstractSlashCommand(String command, @Nullable String prefix) {
        this.name = command;
