package com.awakenedredstone.autowhitelist.util.collections;
...
public class MapBuilder<K, V> {
    ...
    public static class TextMap extends MapBuilder<String, Component> {
        @Override
        public TextMap put(String key, Component value) {
            super.put(key, value);
            return this;
        }

        public TextMap put(String key, String value) {
            super.put(key, Component.literal(value));
            return this;
        }
